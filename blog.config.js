...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:759b9c4832bc4b9e9ec926f11a578ec9',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LoongX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '提供优质的集运服务', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://loongx.ing', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '集运服务, 国际物流', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://loongxing.feishu.cn/share/base/form/shrcnZysDXdS4IlAXddJMIbzT2e', // 你的微博个人主页
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'GS9HFQu9A8yHu-nGMBXQp',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'loongx 国际货运', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '提供优质的集运服务', // 站点描述，被notion中的页面描述覆盖
