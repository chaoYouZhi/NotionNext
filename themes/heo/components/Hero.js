    ...
    <div
      ...
      <div
        ...
        <div className='ml-12 -translate-x-32 group-hover:translate-x-0 duration-300 transition-all ease-in'>
          <div className='text-7xl text-white font-extrabold'>随机漫步</div>
  ...
  return (
    <div
      ...
      <div
        ...
        } shadow transition-all duration-200 today-card h-full bg-[#ffae17] rounded-xl relative overflow-hidden flex items-end`}>
        <div
          id='today-card-info'
          ...
          <div
            ...
            } flex items-center px-3 h-10 justify-center bg-[#dc1f26] hover:bg-[#dc1f26] transition-colors duration-100 rounded-3xl`}>
            <PlusSmall
